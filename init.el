...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (fill-column-indicator neotree zenburn-theme markdown-mode web-mode multiple-cursors uuidgen magit clojure aggressive-indent rainbow-delimiters try which-key exec-path-from-shell use-package smartparens evil-nerd-commenter evil)))
